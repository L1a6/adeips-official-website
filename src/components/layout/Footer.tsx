      ...
      <div className="container-custom py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div>
            ...
            <div className="flex gap-4">
              <a
                href="https://facebook.com/adeips"
                target="_blank"
              ...
              <a
                href="https://instagram.com/adeips"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[var(--adeips-red)] transition-all hover:-translate-y-1"
              ...
              <a
                href="https://linkedin.com/company/adeips"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[var(--adeips-red)] transition-all hover:-translate-y-1"
                aria-label="LinkedIn"
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="mailto:info@adeips.org" className="text-white/70 hover:text-[var(--adeips-red)] transition-colors text-sm font-light">
                  info@adeips.org
                </a>
              </li>
              <li>
                <a href="tel:+2348012345678" className="text-white/70 hover:text-[var(--adeips-red)] transition-colors text-sm font-light">
                  +234 801 234 5678
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-white/10 pt-8 text-center">
          ...
          <p className="text-white/50 text-xs font-light">
            Empowering voices, transforming leaders.
          </p>
        </div>
      </div>
    </footer>
